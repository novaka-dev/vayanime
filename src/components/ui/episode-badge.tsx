...
const BadgeEpisode = React.forwardRef<
  HTMLDivElement,
  ...
  return (
    ...
    >
      {episodes?.sub && (
        <span
          className={cn(
            "flex items-center gap-1 rounded-bl rounded-tl bg-green-200 px-2 py-1 font-medium text-black",
      ...
      {episodes?.dub && (
        <span
          className={cn(
            "flex items-center gap-1 rounded-br rounded-tr bg-sky-200 p-1 font-medium text-black",
            size === "sm" && "px-1.5 py-0.5 text-xs",
          )}
        >
          <FaMicrophone />
...
BadgeEpisode.displayName = "Badge";
